...
sub_A=int(input('Enter the subject marks in A: \n'))
sub_B=int(input('Enter the subject marks in B: \n'))

if sub_A>=55 and sub_B>=45:
    print('This student is Pass')
elif sub_A<55 and sub_B>=55:
    print('This student will be reappear in subject A')
elif sub_A>=65 and sub_B<45:
    print("This student will reappear in subject B ")
else:
